<script>
    function check(){
        ...
        var user_division_id = document.getElementById("user_division_id").value;
        ...
        user_division_id = $.trim(user_division_id);
        ...
        if(user_code.length == 0){
            ...
            return false;
        }else if(user_division_id.length == 0){
            alert("Please input employee division");
            document.getElementById("user_division_id").focus();
            return false;
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                                ...
                                for ($i = 0; $i < count($user_division); $i++) {
                                    ?>
                                    <option value="<?php echo $user_division[$i]['user_division_id'] ?>"><?php echo $user_division[$i]['user_division_name'] ?></option>
                                    <?
                                }
                                ?>
                                </select>
